...
<html lang="en">
  <head>
    ...
    <title>Art Gallery & Shop | <?php echo $title; ?></title>
     ...
     <nav class="navbar navbar-inverse navbar-fixed-top">
		  <div class="container-fluid">
			<div class="navbar-header">
			  ...
			  <a class="navbar-brand" href="#">Art Gallery & Shop</a>
			</div>
			<div>
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			  <ul class="nav navbar-nav navbar-right top_menu">
				...
				<li <?php if($page=="cart") echo 'class="active"' ?>><a href="cart.php">Cart product</a></li>
			  </ul>
			</div>
		  </div>
		</nav>